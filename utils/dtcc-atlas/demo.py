...
# Add parameters (i.e. where is the server located, hostname, port)

# Request data for a specific bounding box

# Get the data from server

# Request data for a specific bounding box that client only has partial data

# Get the missing data from server
